...
function callServer(p, a, h, j, m, k, d, f) {
    ...
    var q = encodeURI(f);
    var o = c + "?sessionId=" + r + "&contentId=" + g + "&externalId=" + i + "&referrer=" + n + "&page=" + l + "&formFactor=mobile&authToken=" + b + "&source=" + q + "&callback=" + e + "&nocache=" + new Date().getTime();
    log("serverURL: " + o);
...
function displayOverlay(d, e) {
    ...
    // var d is overlay html markup
    // replaceString is in separate codekit files
	
    d = wescomReplaceString(d);
    ...
    loadCustomStyleSheet(overlaycss);
